...
class ConstructionAndLegalRecords {
	@IsOptional()
	@IsArray()
	@IsString({ each: true })
...
class UtilitiesEnergyConnectivity {
	@IsOptional()
	@IsString()
	water?: string | null
...
export class SaveListingDto {
	...
	@IsOptional()
	@ValidateNested()
	@Type(() => ConstructionAndLegalRecords)
	constructionAndLegalRecords?: ConstructionAndLegalRecords

	@IsOptional()
	@ValidateNested()
	@Type(() => UtilitiesEnergyConnectivity)
	utilitiesEnergyConnectivity?: UtilitiesEnergyConnectivity
