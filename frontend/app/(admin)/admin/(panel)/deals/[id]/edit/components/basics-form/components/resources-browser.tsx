...
export function ResourcesBrowser({
  ...
  setSelected: (newValue: IResourceSimple) => void;
}) {
  ...
  const filteredData = items.filter((resource) => resource.id !== selected);
  ...
  return (
    <div className="border border-gray-200 rounded-lg p-4 space-y-4">
      <div className="flex justify-between items-center ">
        <h4 className="font-medium text-gray-900">Select Featured Resource</h4>
