...
import { IResourceSection } from "../../../../../../../../../../types/Resource";
...
export function TextImages({ section }: { section: IResourceSection }) {
  ...
  const uploadImage = async (file: File) => {
    ...
    try {
      ...
      const image = await fetcherAdmin(
        `/admin/resources/${dealId}/content-section/${section.id}/text-image`,
        {
          method: "POST",
          credentials: "include",
          body: formData,
  ...
  const removeImage = async (id: number) => {
    ...
    try {
      await fetcherAdmin(
        `/admin/resources/${dealId}/content-section/${section.id}/text-image/${id}`,
        {
          method: "DELETE",
          credentials: "include",
        },
