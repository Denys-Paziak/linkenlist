        ...
        <div className="flex items-center justify-between h-14">
          ...
          <nav className="hidden md:flex items-center space-x-1">
            ...
            <Link
              ...
              onClick={() => handleNavClick("/realestate")}
            >
              Real Estate
            </Link>
            <Link
            ...
            {/* {user.isLoggedIn ? (
              ...
              //             onClick={() =>
              //               handleNavClick("/profile/realestate", () =>
              //                 setIsProfileMenuOpen(false)
              //               )
              //             }
              //           >
              ...
              //             className="flex items-center gap-2 px-4 py-2 text-sm text-foreground hover:bg-secondary transition-colors"
              //             onClick={() =>
              //               handleNavClick("/realestate/packages", () =>
              //                 setIsProfileMenuOpen(false)
              //               )
              //             }
              //           >
              ...
              //   className={`${navItemClasses} font-bold`}
              // >
              //   Sign In
              // </button>
            )} */}
              ...
              <div className="py-3 px-4">
                <div className="flex flex-col space-y-1">
                  ...
                  <Link
                    ...
                    className="px-3 py-1.5 text-sm text-white hover:bg-white/20 hover:text-white transition-colors rounded"
                    onClick={() =>
                      handleNavClick("/links", () => setIsMobileMenuOpen(false))
                    }
                  >
                    Links
                  </Link>
                  <Link
                    ...
                    className="px-3 py-1.5 text-sm text-white hover:bg-white/20 hover:text-white transition-colors rounded"
                    onClick={() =>
                      handleNavClick("/deals", () => setIsMobileMenuOpen(false))
                    }
                  >
                    Deals
                  </Link>
